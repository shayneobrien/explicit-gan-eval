    ...
    for trials in [100]:
        for dimensions in ['16', '32', '64', '128', '256', '512', '1024']:
            for epochs in [15]:
                ...
                call(["python", "main.py", "multivariate", trials, dimensions, epochs])

                call(["python", "main.py", "mnist", trials, dimensions, epochs])

                # call(["python", "main.py", "circles", trials, dimensions, epochs])

                for samples in ['1000', '10000', '100000',] #'1000000']:

                    call(["python", "main.py", "mixture", trials, dimensions, epochs, samples])
